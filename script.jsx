...
//	Generates One Basic Humanoid Hand 
//	in a Rubber Hose Cartoon Style
...
function runIt (reps) {
	...
	for (var j = 1 + cleanRun; j <= reps; j++) {
		...
		//	5	CREATE FOUR "RUBBER HOSE" STYLE FINGERS ON SHAPE LAYER IN COMP
		...
		//	6	CREATE THUMB ON NEW SHAPE LAYER IN COMP
		...
		//	7	ADD NULL LAYER TO COMP & ATTATCH ALL LAYERS
