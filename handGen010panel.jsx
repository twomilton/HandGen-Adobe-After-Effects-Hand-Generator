...

{
   function myScript(thisObj) {
      function myScript_buildUI(thisObj) {
                var myPanel = (thisObj instanceof Panel) ? thisObj : new Window("palette", "", [0, 0, 300, 300]);

                res = "group{orientation:'column', alignment:['fill', 'fill'], alignChildren:['center', 'fill'],\
                        myGroup: Group{orientation:'column', alignment:['fill', 'fill'], \
														alignChildren:['center', 'center'], \
														margin: '15,0,15,20', spacing:'20',\
                            myStaticText: StaticText{text:'How Many Hands?'},\
                            runReps: EditText{text:'1', characters: 6},\
                            runBtn: Button{text:'Generate Hands!'},\
                        },\
                }"
                ...
                myPanel.grp.myGroup.runBtn.onClick = function() {
...
/*
			CAN REUSE THIS BLOCK FOR FINGER NAILS		//	8	CREATE TWO EYEBROWS ON SHAPE LAYER IN COMP
