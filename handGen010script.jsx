...

{
   function myScript(thisObj) {
      function myScript_buildUI(thisObj) {
                var myPanel = (thisObj instanceof Panel) ? thisObj : new Window("palette", "Hand Generator", [0, 0, 300, 300]);

                res = "group{orientation:'column', alignment:['fill', 'fill'], alignChildren:['fill', 'fill'],\
                        myGroup: Group{orientation:'column', alignment:['fill', 'fill'], alignChildren:['fill', 'fill'],\
                            myStaticText: StaticText{alignment:'center', text:'How Many Hands Would You Like to Generate?'},\
                            runReps: EditText{text:'1', characters:50},\
                ...
                myPanel.grp.myGroup.runBtn.onClick = function() {
					...
					//	app.project.item(j).layer("FINGERS").moveBefore(pvShapeLayer);
										...
										//	X	CREATE "RUBBER HOSE" STYLE THUMB ON NEW SHAPE LAYER IN COMP
